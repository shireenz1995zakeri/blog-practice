...
<head>
    ...
    <title>بلاگ{{ $title ?? '' }}</title>
    <meta name="description" content=" وبسایت آموزش برنامه نویسی وب و موبایل ، جاوااسکریپت ، لاراول ، react ، آموزش node js با مجرب ترین مدرسین">
    <meta name="keywords" content="آموزش طراحی سایت,آموزش برنامه نویسی,طراحی وب,ساخت وب سایت,آموزش git,آموزش لاراول,آموزش php,آموزش react,آموزش پی اچ پی,آموزش laravel,آموزش جاوا اسکریپت,آموزش ساخت وب سایت,آموزش mvc,آموزش React Native,وب آموز , وب اموز">
...
<body>
            ...
            <div class="c-header__row ">
                <div class="c-header__right">
                    ...
                    <div class="c-search width-100 ">
                        <form action="{{ route('post.search')}}" class="c-search__form position-relative">
                            <input type="text" class="c-search__input" placeholder="جستجو کنید" name="search" value="{{ request()->search ?? '' }}">
                ...
                <div class="c-header__left">
                    ...
                    <div style="width: 180px;">
                        <div class="dropdown-select wide open" id="dropdown-user" onclick="toggleUserDropdown()" tabindex="0">
                            <span class="current">
                                {{auth()->user()->name}}
                            </span>
            ...
            <div class="container container--nav">
                <ul class="nav__ul">
                    ...
                    <li class="nav__item nav__item--has-sub">
                        <a href=" {{ route('category.show',$category->slug)}}" class="nav__link">{{$category->name}}</a>
                        <div class="nav__sub">
    ...
    <footer class="footer">
        ...
        <div class="footer__webamooz">
            طراحی و توسعه با لاراول(نسخه آزمایشی)
