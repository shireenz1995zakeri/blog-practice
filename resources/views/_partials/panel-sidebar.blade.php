<ul>
        <li class="item-li i-dashboard is-active">
        ...
        <li class="item-li i-users @if(request()->is('panel/users') || request()->is('panel/users/*')) is-active @endif">
            <a href="{{route('users.index')}}"><i class="fa fa-user-o" aria-hidden="true"></i>کاربران</a>
        </li>
        ...
        @endif
        <li class="item-li i-user__inforamtion"><a href="{{route('profile')}}">اطلاعات کاربری</a></li>
    </ul>