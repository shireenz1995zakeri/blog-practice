                ...
                <tbody>
                    ...
                    <tr role="row" class="">
                        ...
                        <td>
                            ...
                            <a href="" class=" mlg-15" title="حذف" style="color: red;" onclick="destroyUser(event,'{{$user->id}}')">حذف</a>
                            @endif()
                            <a href="{{route('users.edit',$user->id)}}" title="ویرایش" style="color: green;">ویرایش</a>
    ...
    <x-slot name="scripts">
        ...
        <script>
            function destroyUser(event, id) {
                ...
                Swal.fire({
                title: 'آیا مطمعن هستید می خواهید این کاربر را حدف کنید؟',
                text: "",
                icon: 'warning',
